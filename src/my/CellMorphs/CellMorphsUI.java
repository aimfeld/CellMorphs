 ...
 */
public class CellMorphsUI extends javax.swing.JFrame {
...
//            }
    ...
    private void initComponents() {
        ...
        jPanelCM1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelCM1Layout.createSequentialGroup()
                .addComponent(jPanelSelect1, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelCM2Layout.setVerticalGroup(
            jPanelCM2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelCM2Layout.createSequentialGroup()
                .addComponent(jPanelSelect2, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelCM3Layout.setVerticalGroup(
            jPanelCM3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelCM3Layout.createSequentialGroup()
                .addComponent(jPanelSelect3, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelCM4Layout.setVerticalGroup(
            ...
            .addGroup(jPanelCM4Layout.createSequentialGroup()
                .addComponent(jPanelSelect4, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelCM5Layout.setVerticalGroup(
            jPanelCM5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelCM5Layout.createSequentialGroup()
                .addComponent(jPanelSelect5, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelCM6Layout.setVerticalGroup(
            jPanelCM6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelCM6Layout.createSequentialGroup()
                .addComponent(jPanelSelect6, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void CMCanvasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CMCanvasMousePressed
        for (int i = 0; i < CellMorphCount; i++)
            if (Canvases[i] == evt.getComponent())
                Select(i, false);
    }//GEN-LAST:event_CMCanvasMousePressed
    
    private void jSpinnerGenerationStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSpinnerGenerationStateChanged
    ...
    }//GEN-LAST:event_jSpinnerGenerationStateChanged
    ...
    private void cACanvasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cACanvasMousePressed
        
    }//GEN-LAST:event_cACanvasMousePressed
...
//        validate(); // Will resize the canvases again because of anchoring
    ...
    private void jButtonBigViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBigViewActionPerformed
        jButtonStopActionPerformed(null);
        new BigViewFrame(CellMorphs[Selected].CopyGenes(), RenderType).setVisible(true);
    }//GEN-LAST:event_jButtonBigViewActionPerformed
